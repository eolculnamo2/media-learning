...
function FileLayoutViz() {
  ...
  return <div><div className="desktop-controls"><ControlButton active={fast} onClick={() => setFast(true)}>fast start</ControlButton><ControlButton active={!fast} onClick={() => setFast(false)}>moov at end</ControlButton></div><SvgFrame height={280} label="MP4 byte layout" children={draw} /></div>
}
