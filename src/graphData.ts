...
export const nodes: Node[] = [
  ...
  },
  {
    ...
    label: 'ctts',
    category: 'timing',
    description: 'Composition Time to Sample Box. Maps decode timing to presentation timing when samples are presented out of decode order.',
    whyItMatters: 'Progressive MP4 files use ctts to preserve PTS offsets for codecs with frame reordering, such as B-frames.',
  },
  {
    id: 'stsc',
    label: 'stsc',
    category: 'sample-table',
    description: 'Sample To Chunk Box. Maps samples into chunks in a progressive MP4 sample table.',
    whyItMatters: 'Together with stsz and stco/co64, it lets a demuxer locate each sample byte range in mdat.',
  },
  {
    id: 'stss',
    label: 'stss',
...
export const edges: Edge[] = [
  ...
  { source: 'stbl', target: 'ctts', label: 'may contain', description: 'The sample table may contain ctts to map decode time to presentation time.' },
  { source: 'stbl', target: 'stsc', label: 'contains', description: 'The sample table contains stsc to map samples into chunks.' },
